...
export class ProductCreateComponent implements OnInit {
  product: ProductInputModel = { productName: undefined,brand:undefined,releaseDate:undefined, price: undefined, isAvailable: undefined };

  productForm: FormGroup = new FormGroup({
    productName: new FormControl('', Validators.required),
    brand: new FormControl('',Validators.required),
    releseDate: new FormControl(undefined, Validators.required),
