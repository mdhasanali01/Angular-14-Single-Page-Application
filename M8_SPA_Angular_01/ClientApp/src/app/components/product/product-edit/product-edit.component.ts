...
export class ProductEditComponent implements OnInit {   
  ...
  save(){
    ...
    //  console.log(this.product);
     let data:ProductInputModel = {productID:this.product.productID, productName: this.product.productName, price:this.product.price,brand:this.product.brand,releaseDate:this.product.releaseDate, isAvailable:this.product.isAvailable};
